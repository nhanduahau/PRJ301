...
public class CreateAccountController extends HttpServlet {
    ...
    private static final String ERROR = "createAccountPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String txtWallet = request.getParameter("txtWallet");
            float wallet = Float.parseFloat(txtWallet);
            Account account = new Account(txtUserName, txtPassword, txtFullName, wallet);
