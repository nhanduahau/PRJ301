...
public class CreateCakeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String txtCakeImage = request.getParameter("txtCakeImage");
            Cakes cake = new Cakes(txtCakeID, txtCakeName, txtCakeDescription, Float.parseFloat(txtCakePrice), txtCakeImage);
            CakeDAO dao = new CakeDAO();
            boolean result = dao.CreateCake(cake);
            if (result == false) {
