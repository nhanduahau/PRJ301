...
public class LoginController extends HttpServlet {
    ...
    private static final String USER_PAGE = "CakesController";
  //  private static final String USER_PAGE = "userPage.jsp";
    ...
    public void setUserSesison(HttpServletRequest request, Users loginUser) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Users user = dao.checkLogin(txtUsername, txtPassword);
            if (user != null) {
                String role = user.getRoleID();
                if (role.equals(ADMIN)) {
                    url = ADMIN_PAGE;
                    setUserSesison(request, user);
